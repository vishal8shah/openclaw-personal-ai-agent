...
| Guide | What You Get |
|:------|:-------------|
| [Security Guide](docs/security) | End-to-end hardening walkthrough — WSL2 to production |
| [Observability Guide](docs/observability) | Five-layer monitoring: host, pipeline, runtime, economics |
| [Troubleshooting](docs/troubleshooting) | Every real error encountered + verified fix |
