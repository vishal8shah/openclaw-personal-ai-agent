...
This guide is a companion to the [Security Guide](security). The agent should be hardened before instrumenting it.
...
> **Calibration note:** Thresholds that look sensible on paper will fire immediately against real usage. Calibrate against at least one full day of live traffic before treating these as pages.
